...
async def page(application_page: str, product_id: int = None, country_name: str = None, product_category_id: int = None, limit: int = None, offset: int = None, current_page_number: int = None, brand_id: int = None, brand_name: str = None):
    ...
    if application_page == 'product':
        ...
        if country_details is None:
            ...
            similar_products = await product.get_similar_products(product_details['product_category_id'], product_object)
    ...
    if application_page == 'category':
        ...
        if country_details is None:
            ...
            category_products_dict = await product.get_category_products_with_pagination(product_category_id, product_object, limit, offset, current_page_number)
    ...
    if application_page == 'brand':
        ...
        if country_details is None:
            ...
            brand_products_dict = await brand.get_brand_products_with_pagination(brand_name, product_object, limit, offset, current_page_number, country_name)
...
async def page_route_new(application_page: str, product_id: Optional[int] = None, country_name: Optional[str] = None, product_category_id: Optional[int] = None, brand_id: Optional[int] = None, brand_name: Optional[str] = None, limit: Optional[int] = None, offset: Optional[int] = None, current_page_number: Optional[int] = None):
    ...
    # update global product page attributes
    if application_page == 'category':
        return await page(application_page, product_category_id=product_category_id, country_name=country_name, limit=limit, offset=offset, current_page_number=current_page_number)
    if application_page == 'brand':
        return await page(application_page, brand_name=brand_name, country_name=country_name, limit=limit, offset=offset, current_page_number=current_page_number)
